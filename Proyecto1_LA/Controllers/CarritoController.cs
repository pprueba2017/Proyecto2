    ...
    public class CarritoController : Controller
    {
        ...
        public void validacion()
        {
            ...
            foreach (var item in Session["carrito"] as List<Proyecto1_LA.Models.CarritoItem>)
            {
             ...
             char[] Cadena = nuevopro.Descripcion.ToCharArray(); //aqui se cargar 

                for (int i = 0; i < Cadena.Length; i++) //aqui se descarada la cadena 
                {
                    if (b ==1)
                    {
                    ...
                    if (Cadena[i] == ' ' || Cadena[i] == '\n')
                    {
                        ...
                        if (a > 0)
                        {
                                ...
                                {
                                    socket2 = "Socket:" + caracter;
                                    b = 1;
                                    count1 = 1;
                                }

                        }
                        if (caracter == " Socket:" || caracter == "Socket:") 
                        {
                            a = i;         
